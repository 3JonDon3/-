...
# --- Фон ---
bg_img = pygame.image.load("WWTBAM_Logo_Ukraine_on_BG_2021.webp")  # твій фон
background = pygame.transform.scale(bg_img, (WIDTH, HEIGHT))  # фон на весь екран
...
while running:
    screen.blit(background, (0, 0))  # повністю фон
